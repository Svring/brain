    ...
    <>
      ...
      <div className="w-full h-full relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 w-full h-full flex items-center justify-center">
          <div className="scroll-container w-full h-full max-w-6xl">
            <div className="infinite-scroll flex gap-6 w-max h-full">
              {duplicatedImages.map((image, index) => (
                <div
                  key={index}
                  className="image-item flex-shrink-0 h-full aspect-square rounded-xl overflow-hidden shadow-2xl"
                >
                  <img
                    src={image}
