...
import { ClusterPausePayload } from "@/components/chat/messages/tool-messages/tool-message-types";
...
export const PauseClusterToolMessage: React.FC<PauseClusterToolMessageProps> = ({
  ...
  const payload = result.payload as ClusterPausePayload;
    ...
    <div className="flex justify-start w-full">
      <div className="bg-background-secondary border border-border-primary rounded-lg p-4 max-w-full">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-semibold text-foreground">Pause Cluster</h3>
        </div>
