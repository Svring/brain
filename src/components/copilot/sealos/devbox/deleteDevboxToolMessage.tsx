...
import { DevboxDeletePayload } from "@/components/chat/messages/tool-messages/tool-message-types";
...
export const DeleteDevboxToolMessage: React.FC<DeleteDevboxToolMessageProps> = ({
  ...
  const payload = result.payload as DevboxDeletePayload;
    ...
    <div className="flex justify-start w-full">
      <div className="bg-background-secondary border border-border-primary rounded-lg p-4 max-w-full">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-semibold text-foreground">Delete Devbox</h3>
        </div>
