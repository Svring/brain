...
interface CreateLaunchpadPortsToolMessageProps {
  result: ToolActionResult;
}

export const CreateLaunchpadPortsToolMessage: React.FC<CreateLaunchpadPortsToolMessageProps> = ({
  result,
}) => {
  ...
  const getStatusDisplay = () => {
    if (!isApproved) {
      return {
        ...
        text: "Launchpad ports creation rejected"
      };
    }
    ...
    return {
      ...
      text: "Launchpad ports created successfully"
    };
  };
