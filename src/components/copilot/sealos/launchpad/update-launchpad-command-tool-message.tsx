...
interface UpdateLaunchpadCommandToolMessageProps {
  result: ToolActionResult;
}

export const UpdateLaunchpadCommandToolMessage: React.FC<
  UpdateLaunchpadCommandToolMessageProps
> = ({ result }) => {
  ...
  const getStatusDisplay = () => {
    if (!isApproved) {
      return {
        ...
        text: "Launchpad command update rejected"
      };
    }
    ...
    if (!isSuccess) {
      return {
        ...
        text: result.message || "Launchpad command update failed"
      };
    }
