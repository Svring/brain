...
interface GetLaunchpadNetworkToolMessageProps {
  result: ToolActionResult;
}

export const GetLaunchpadNetworkToolMessage: React.FC<GetLaunchpadNetworkToolMessageProps> = ({
  result,
}) => {
  ...
  // console.log("result of network", result);

  useMount(() => {
    invalidateQueries([launchpad.networkStatus.queryKey()]);
  });
  ...
  const getStatusDisplay = () => {
    if (!isApproved) {
      return {
        ...
        text: "Launchpad network information retrieval rejected"
      };
    }
    ...
    return {
      ...
      text: "Launchpad network information retrieved successfully"
    };
  };
