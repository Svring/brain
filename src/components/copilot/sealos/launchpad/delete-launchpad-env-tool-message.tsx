...
interface DeleteLaunchpadEnvToolMessageProps {
  result: ToolActionResult;
}

export const DeleteLaunchpadEnvToolMessage: React.FC<DeleteLaunchpadEnvToolMessageProps> = ({
  result,
}) => {
  ...
  const getStatusDisplay = () => {
    if (!isApproved) {
      return {
        ...
        text: "Launchpad environment variable deletion rejected"
      };
    }
    ...
    return {
      ...
      text: "Launchpad environment variable deleted successfully"
    };
  };
