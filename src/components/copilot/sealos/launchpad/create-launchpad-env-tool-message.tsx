...
interface CreateLaunchpadEnvToolMessageProps {
  result: ToolActionResult;
}

export const CreateLaunchpadEnvToolMessage: React.FC<CreateLaunchpadEnvToolMessageProps> = ({
  result,
}) => {
  ...
  const getStatusDisplay = () => {
    if (!isApproved) {
      return {
        ...
        text: "Launchpad environment variable creation rejected"
      };
    }
    ...
    return {
      ...
      text: "Launchpad environment variable created successfully"
    };
  };
