...
interface RestartDevboxToolCallMessageProps {
  devbox_name: string;
  runtime?: string;
  type?: string;
}

export function RestartDevboxToolCallMessage({
  devbox_name,
  runtime,
  type = "default",
}: RestartDevboxToolCallMessageProps) {
  const iconUrl =
    DEVBOX_RUNTIME_ICONS[type as keyof typeof DEVBOX_RUNTIME_ICONS] ||
    DEVBOX_DEFAULT_ICON;
