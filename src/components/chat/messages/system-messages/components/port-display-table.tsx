              ...
              <TableCell className="max-w-0">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-muted-foreground px-2 py-1 rounded-full w-12 text-center">private</span>
                  ...
                  {/* Public Address */}
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-muted-foreground px-2 py-1 rounded-full w-12 text-center">public</span>
                    <div className="flex items-center gap-2 flex-1">
                      {port.publicAddress ? (
                        <>
                          <span
                  ...
                  {port.customDomain && (
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-muted-foreground px-2 py-1 rounded-full w-12 text-center">custom</span>
                      <div className="flex items-center gap-2 flex-1">
                        <span
                          className={cn(
                            "truncate cursor-pointer hover:text-foreground/80 hover:underline",
                          ...
                          onClick={() => {
                            window.open(`https://${port.customDomain}`, "_blank");
                          }}
                        >
                          {port.customDomain}
                        </span>
