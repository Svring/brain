...
export function ClusterSuccessState({
  createdClusterName,
  form,
}: ClusterSuccessStateProps) {
  return (
    <div className="space-y-3 flex-col bg-background-secondary p-3 rounded-xl">
      ...
      <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
        ...
        <div>
          ...
          <div className="text-sm text-green-700 dark:text-green-300">
            CPU: {form.getValues("cpu")}m • Memory: {form.getValues("memory")}Mi
            • Storage: {form.getValues("storage")}Gi • Replicas:{" "}
      ...
      <div className="text-sm text-muted-foreground">
        <p>
          Your database cluster is now ready to use. You can access it from the
          project dashboard.
        </p>
      </div>
    </div>
