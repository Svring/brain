...
import { DevboxPortSimpleUpdate } from "@/schemas/forms/devbox/components/devbox-port-schema";

interface DevboxSimplePortsFieldsProps {
  fieldArray: any; // useFieldArray return type
}

export const DevboxSimplePortsFields = ({
  fieldArray,
}: DevboxSimplePortsFieldsProps) => {
  const form = useFormContext<{ simplePorts: DevboxPortSimpleUpdate[] }>();
