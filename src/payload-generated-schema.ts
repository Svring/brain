...
export const users = pgTable(
  "users",
  {
    ...
    regionUrl: varchar("region_url").notNull(),
    kubeconfig: varchar("kubeconfig").notNull(),
    regionToken: varchar("region_token"),
    appToken: varchar("app_token").notNull(),
    devboxToken: varchar("devbox_token"),
