// trpc/contexts/launchpadContext.ts
export async function createLaunchpadContext(opts: { req: Request }) {
...
export type LaunchpadContext = Awaited<
  ReturnType<typeof createLaunchpadContext>
>;
