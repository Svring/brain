...
import { listTemplates } from "@/lib/sealos/resources/template/template-api/template-old-api";
...
export default async function ChatLayout({
  ...
  const sealosContext = await createSealosContext();

  await queryClient.prefetchQuery({
    queryKey: ["templates"],
    queryFn: () => runParallelAction(listTemplates(sealosContext)),
  });
