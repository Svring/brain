...
import { convertResourceObjectsToNodes, convertResourceToNodes, addDevboxToDevGroup, convertResourceToNetworkNodes } from "@/lib/flowgraph/nodes/flowgraph-nodes-utils";
import { K8sResource } from "@/lib/k8s/k8s-api/k8s-api-schemas/resource-schemas/kubernetes-resource-schemas";

// Overloaded function signatures
export default function useFlowgraphNodes(resources: K8sResource[], basicMode: true): { nodes: any[]; edges: any[] };
export default function useFlowgraphNodes(resourceObjects: any[], basicMode?: false): { nodes: any[]; edges: any[] };
export default function useFlowgraphNodes(data: any[], basicMode = false): { nodes: any[]; edges: any[] } {
